...
const sessionScenarioToEngineKey = new Map<string, GroupChat['mode']>([
  ...
  ['opinion-review', 'group_discussion'],
  ['roundtable-review', 'group_discussion'],
  ['role-debate', 'group_discussion'],
  ['courtroom-deliberation', 'group_discussion'],
  ['expert-review', 'group_discussion'],
  ['public-inquiry', 'group_discussion'],
  ['brainstorm-workshop', 'group_discussion'],
