...
export default function AdminRiskPage() {
  ...
  return (
    <Stack spacing={2}>
      <AdminSection title="风控限制" subtitle="查询用户限制项，或写入、解除指定限制。">
        <Stack spacing={1.25}>
      ...
      <AdminSection title="限制项" subtitle="点击行查看限制详情。" bodySx={{ p: 0 }}>
        <AdminTableFrame minWidth={700}>
          <Table>
            <TableHead>
              <TableRow>
